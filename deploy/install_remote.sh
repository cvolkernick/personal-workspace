...
#   panamerica-auto:8795
#
# Each unit binds 0.0.0.0, --no-browser (dashboards also --local for API on Pi).
...
ss -lntp 2>/dev/null | grep -E ':(8000|8765|8770|8780|8787|8790|8795)\b' || true
REMOTE

echo ""
echo "Deploy complete."
echo "  Backends (LAN):  http://$RHOST:8790  :8000  :8765  :8770  :8780  :8787  :8795"
...
echo "  Panamerica:      http://$RHOST:8795/  (or bash business/panamerica-auto/start.command)"

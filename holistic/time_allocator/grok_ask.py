...
def build_time_context(payload: dict[str, Any]) -> dict[str, Any]:
    ...
    return {
        ...
        "sleep_battery": {
            "model": sleep.get("model"),
            "mode": sleep.get("mode"),
            "pct_charged": sleep.get("pct_charged") or sleep.get("pct_of_target"),
            "hours_awake": sleep.get("hours_awake"),
            "hours_until_empty": sleep.get("hours_until_empty"),
            "awake_budget_hours": sleep.get("awake_budget_hours"),
            "last_wake_at": sleep.get("last_wake_at"),
            "last_sleep_hours": sleep.get("last_sleep_hours"),
            "empty_at": sleep.get("empty_at"),
            "asleep_hours_24h": sleep.get("asleep_hours"),
            "sleep_target_hours": sleep.get("sleep_target_hours") or sleep.get("target_hours"),

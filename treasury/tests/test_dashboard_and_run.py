...
class TestDashboardArtifact(unittest.TestCase):
    def test_index_has_dual_venue_and_actions(self):
        ...
        self.assertIn('k: "CB ONE CARD"', html)
        self.assertNotIn('k: "NAV"', html)
        self.assertNotIn('k: "LTV"', html)
        self.assertNotIn('k: "Card"', html)
        ...
        self.assertNotIn("m-var-apr", html)
        self.assertNotIn("Coinbase BTC-backed Morpho loan APR override", html)
        self.assertNotIn("m-principal", html)
        self.assertNotIn("m-collateral", html)
        self.assertNotIn("m-liq-price", html)
        self.assertIn("morpho-live", html)
        self.assertIn("Coinbase Borrow smart wallet", html)
        self.assertIn("m-rh-margin-apr", html)
        ...
        self.assertIn("function formatNetworkHashrate", html)
        self.assertIn("Bitcoin network", html)
        self.assertIn(">Bitcoin</span>", html)
        self.assertIn("fillGlanceNextPay", html)
        self.assertIn("SOL⚠", html)
        self.assertIn("actorLabel", html)
        self.assertIn("effectiveActor", html)
        self.assertIn("ltvChipSub", html)
        self.assertIn("oneCardChipSub", html)
        self.assertIn("s: ltvChipSub()", html)
        self.assertIn("ltvLiqBarometerHtml", html)
        self.assertIn("ltv-liq-baro", html)
        self.assertIn("morphoLiqUsd", html)

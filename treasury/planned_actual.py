...
SoT:
  ...
  Thaís   — Coinbase v2 USDC type=send only (lend/lock ignored).
            Standing dest AwMH3… $900 monthly on the 10th (Chris 2026-09-13).
            $415 biweekly is no longer the post-9/11 rule.
            Pre-standing dest-only $895 (2026-08-10) and named-address still join.
  ...
  JR      — self-send dest CzuRx… $35 manual Friday reminder. Not automatic $70.
            Not Rent / Thaís / mint. Surface only when a sheet item already joins.
...
def build_planned_actual_strip(
    ...
    *,
    ...
    for item in items:
        ...
        # $25 * days, 14×$25, weekly $208, or standing $900/$350/$35.
    ...
    return {
        ...
        "notes": (
            ...
            "(Thaís = dest AwMH3… $900 monthly on the 10th; "
            "Rent = one $350 send to nvolkern@gmail.com every 14d from 2026-09-11; "
            "JR self-send = dest CzuRx… $35 manual Friday reminder, not automatic $70). "

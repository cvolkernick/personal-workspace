...
Serves static UI + APIs:
  ...
  GET  /api/cash-streams-rolling — 90d chart of 30d mean inflow and outflow; Lyft, Grubhub, Turo, and other stacked under inflow
...
def main(argv: list[str] | None = None) -> int:
    ...
    print(
        f"Position dossier          → http://127.0.0.1:{args.port}/financial-command/position.html"
    )

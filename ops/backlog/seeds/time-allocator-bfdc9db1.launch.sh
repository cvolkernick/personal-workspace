#!/bin/bash
# Start Grok with /goal preloaded from backlog: Time allocator
set -euo pipefail
ROOT="$(cd "$(dirname "$0")/../../.." && pwd)"
cd "$ROOT"
PROMPT_FILE="$ROOT/ops/backlog/seeds/time-allocator-bfdc9db1.prompt.txt"
SEED="$ROOT/ops/backlog/seeds/time-allocator-bfdc9db1.md"
OBJ="$ROOT/ops/backlog/seeds/time-allocator-bfdc9db1.goal.txt"

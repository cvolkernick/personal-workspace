# Fund manager research — mid-session 2026-07-30 (team full review, ~12:58 ET)

**As of:** 2026-07-30 ~16:58Z  
**Account:** agentic ••••1752 only  
**Process:** Uniform research/rotate (size-invariant)  
**Live NAV (agentic RH total):** ~$175.16 (RH) / ~$174.75 (Yahoo live marks + cash)  
**cash/BP:** ~$0.04 · **min_trade:** $1.00  
**Equity (Yahoo live marks):** ~$174.71  
**RH snapshot as_of:** 2026-07-30T16:36:01Z (**live / fresh**; ~22m age at decision)  
**MCP (this Grok session):** robinhood-trading tools **unavailable** (auth/connection failed; search_tool empty) — Executor cannot place  
**Owner prefs (2026-07-27):** elevate **STRC/SATA** in BTC-complex deploys; **multi-miner diversification good**  
**Trigger:** rules `need_llm` on free capital any cash/BP>0 (dust residual) + scheduled mid-session team review
...
| Deployed sleeve mix | **~40.3%** BTC-complex / **~59.7%** stocks (Yahoo live) · policy engine **40.0 / 60.0** — **in ±5% band** |
| Weights of NAV (policy) | BTC ~39.9% · stocks ~59.8% · cash ~0.02% |
...
### Live market values (agentic qty × Yahoo regular-session marks ~12:58 ET)

| Symbol | Sleeve | Theme | ~$ | % of equity (approx) |
|--------|--------|-------|-----|----------------------|
| MSTR | btc | digital credit | 28.43 | ~16.3% |
| BITA | btc | BTC yield | 15.04 | ~8.6% |
| MARA | btc | miner | 11.47 | ~6.6% |
| IREN | btc | miner/power infra | 10.23 | ~5.9% |
| CLSK | btc | miner | 5.24 | ~3.0% |
| TSLA | stocks | growth | 59.46 | ~34.0% |
| SPCX | stocks | growth | 44.84 | ~25.7% |

**Sub-sleeve notes (BTC complex ~$70.41):**
- Digital credit/yield (MSTR+BITA): ~$43.47 (~62% of complex) — **no STRC/SATA seat**
- Miners/infra (MARA+IREN+CLSK): ~$26.94 (~38% of complex) — multi-miner stack OK per owner pref
- Unheld digital credit quotes: STRC ~$89.36 · SATA ~$97.10 · ASST ~$11.89
- Unheld miner quotes: RIOT ~$22.60 · WULF ~$18.12
- Watchlist quotes: BE ~$206.43 · GOOGL ~$334.34 · AAPL ~$331.71 · NVDA ~$193.35
...
| **BE** | Prior dive 2026-07-23 `monitor_no_buy`; Q2 print beat + raised FY26 guidance. Still **not first-buy ready** until **post-print deep-dive refresh** + quorum. Residual dust cannot size. |
...
- MCP outage this session is an **execution/ops constraint**, not a reason to skip research/rotate. RH snapshot itself is live via external refresh.

## Team votes (this pass)

| Role | Vote | Note |
|------|------|------|
| Scout | ok | Snapshot agentic ••••1752: NAV~$175.16 equity 7 names cash/BP $0.04; sleeves ~40/60 in band; RH snapshot 16:36Z; MCP tools unavailable this Grok session |
| Thesis | ok (hold) | Book on target; plan next deploy with STRC/SATA seat in BTC complex; multi-miner retained |
| Risk | ok (hold) | No trade: BP dust; agentic-only; no leverage; TSLA elevated (~34% equity) but thesis primary growth name — no forced cut |

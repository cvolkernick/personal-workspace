# Fund manager research — 2026-08-03 (~11:07 ET / BP-poll need_llm)

**As of:** 2026-08-03 ~15:07Z (~11:07 ET, regular hours; mid-session style)  
...
**Equity (Yahoo live marks):** ~$177.22 · NAV+cash Yahoo ~$177.31  
**RH snapshot as_of:** 2026-08-03T14:49:39.562252+00:00 (Pi pull ~15:06Z; age ~17m)  
...
**Trigger:** BP poll rules path → need_llm (any cash/BP >$0 dust) at 2026-08-03T15:06:37Z  
**Prior full team same day:** HOLD ~09:40 / ~09:56 / ~10:14 / ~10:31 / ~10:50 ET — book unchanged (still dust)
...
### Live market values (agentic qty × Yahoo chart ~11:07 ET)

| Symbol | Sleeve | Theme | ~$ | % of equity (approx) |
|--------|--------|-------|-----|----------------------|
| MSTR | btc | digital credit | 27.90 | ~15.7% |
| BITA | btc | BTC yield | 14.90 | ~8.4% |
| MARA | btc | miner | 11.31 | ~6.4% |
| IREN | btc | miner/power infra | 10.70 | ~6.0% |
| CLSK | btc | miner | 5.23 | ~3.0% |
| TSLA | stocks | growth | 62.62 | ~35.3% |
| SPCX | stocks | growth | 44.56 | ~25.1% |

**Sub-sleeve notes (BTC complex ~$70.04 Yahoo):**
- Digital credit/yield (MSTR+BITA): ~$42.80 (~61% of complex) — **no STRC/SATA seat**
- Miners/infra (MARA+IREN+CLSK): ~$27.24 (~39% of complex) — multi-miner stack OK per owner pref
- Unheld digital credit: STRC ~$91.91 · SATA ~$97.12 · ASST ~$11.89
- Unheld miners: RIOT ~$21.06 · WULF ~$18.62
- Watchlist: BE ~$218.91 · GOOGL ~$369.42 · AAPL ~$304.82 · NVDA ~$206.43
- BTC-USD ~$63,776
...
| Role | Vote | Note |
|------|------|------|
| Scout | ok | Snapshot agentic ••••1752: NAV RH ~$177.24 / Yahoo ~$177.31; 7 names; cash/BP $0.09; sleeves policy 40/60 in band; Yahoo equity ~39.5/60.5; RH snapshot 2026-08-03T14:49:39Z; MCP tools unavailable; ~11:07 ET regular hours |

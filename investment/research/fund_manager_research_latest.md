# Fund manager research — mid-session 2026-07-31 (scheduled / need_llm, ~14:35 ET)

**As of:** 2026-07-31 ~18:35Z  
**Account:** agentic ••••1752 only  
**Process:** Uniform research/rotate (size-invariant)  
**Live NAV (agentic RH total):** ~$172.62  
**cash/BP:** ~$0.04 · **min_trade:** $1.00  
**Equity (Yahoo live marks):** ~$172.11 · NAV+cash Yahoo ~$172.15  
**RH snapshot as_of:** 2026-07-31T18:07:46.025492+00:00 (last live sync; MCP unavailable this session for refresh)  
...
**Trigger:** rules path → need_llm (any cash/BP >$0 dust); prior full team HOLDs today ~11:58–14:08 ET
...
| Deployed sleeve mix | **Policy 40% / 60%** BTC-complex / stocks (RH marks, **in band**) · Yahoo live **~39.9% / 60.1%** of equity |
...
### Live market values (agentic qty × Yahoo marks ~14:35 ET)

| Symbol | Sleeve | Theme | ~$ | % of equity (approx) |
|--------|--------|-------|-----|----------------------|
| MSTR | btc | digital credit | 27.42 | ~15.9% |
| BITA | btc | BTC yield | 14.71 | ~8.5% |
| MARA | btc | miner | 11.10 | ~6.5% |
| IREN | btc | miner/power infra | 10.28 | ~6.0% |
| CLSK | btc | miner | 5.10 | ~3.0% |
| TSLA | stocks | growth | 60.44 | ~35.1% |
| SPCX | stocks | growth | 43.07 | ~25.0% |

**Sub-sleeve notes (BTC complex ~$68.60 Yahoo):**
- Digital credit/yield (MSTR+BITA): ~$42.12 (~61% of complex) — **no STRC/SATA seat**
- Miners/infra (MARA+IREN+CLSK): ~$26.48 (~39% of complex) — multi-miner stack OK per owner pref
- Unheld digital credit quotes: STRC ~$89.3 · SATA ~$97.15 · ASST ~$11.085
- Unheld miner quotes: RIOT ~$20.865 · WULF ~$18.003
- Watchlist quotes: BE ~$212.99 · GOOGL ~$355.96 · AAPL ~$302.0 · NVDA ~$198.72
- BTC-USD ~$63,011
...
| **BE** | Prior dive 2026-07-23 `monitor_no_buy`; Q2 print beat; price ~$212.99. Still **not first-buy ready** until **post-print deep-dive refresh** + quorum. Residual dust cannot size. |
...
| Role | Vote | Note |
|------|------|------|
| Scout | ok | Snapshot agentic ••••1752: NAV RH ~$172.62 / Yahoo ~$172.15; 7 names; cash/BP $0.04; sleeves policy 40/60 in band; RH snapshot 2026-07-31T18:07:46.025492+00:00; MCP tools unavailable |

...
| **Digital credit** | BTC-linked corporate / structured credit, yield, and fixed-income proxies | MSTR, **STRC**, **SATA**, ASST, **BITA** — owner elevates STRC/SATA (not MSTR-only by habit) |
...
- **Digital credit (STRC/SATA):** Prefer a real seat in the ~40% complex on deploys — not “covered by MSTR+BITA” as a default skip.

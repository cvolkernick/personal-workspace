...
- `GET /api/dashboard` — sessions, analytics, health, recovery (Trends calories intake vs burned is a **90d** rolling paired window, same as sleep / macros / weight / hydration / volume / AZM)

...
assert(androidHref.indexOf("intent://open#Intent;") === 0, "android starts with intent://open#Intent");
assert(
  androidHref.indexOf("scheme=planetfitness.app.link") >= 0,
  "android Branch scheme"
);
assert(androidHref.indexOf("scheme=planetfitness;") < 0, "android is not bare planetfitness scheme");

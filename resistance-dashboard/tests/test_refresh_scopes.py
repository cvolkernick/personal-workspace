...
class CacheAndHobbyLock(unittest.TestCase):
    def test_static_cache_bumped(self):
        self.assertIn("?v=pace-rows-650-1", HTML)
        ...
        self.assertNotIn("fitdash-shell-v114", SW)
        self.assertNotIn("fitdash-shell-v111", SW)
        ...
        self.assertNotIn("/app.js?v=home-tag-919-1", SW)
        self.assertNotIn("/app.js?v=home-tag-919-1", HTML)
        ...
        self.assertNotIn("/app.js?v=meal-micro-1", SW)
        self.assertNotIn("/app.js?v=meal-micro-1", HTML)
        ...
        self.assertNotIn("micros-bars-1", HTML)
        self.assertNotIn("micros-bars-1", SW)
        self.assertNotIn("fitdash-shell-v85", SW)
        self.assertNotIn("/app.js?v=pf-club-pass-1", SW)
        self.assertNotIn("/app.js?v=pf-club-pass-1", HTML)
        ...
        self.assertNotIn("/app.js?v=labs-2", SW)
        self.assertNotIn("/app.js?v=labs-2", HTML)
        self.assertNotIn("/app.js?v=library-1", SW)
        self.assertNotIn("/app.js?v=library-1", HTML)
        ...
        self.assertNotIn("fitdash-shell-v99", SW)
        self.assertNotIn("fitdash-shell-v98", SW)
        self.assertNotIn("fitdash-shell-v95", SW)
        ...
        self.assertNotIn("fitdash-shell-v84", SW)
        ...
        self.assertNotIn("/app.js?v=recipes-1", HTML)
        self.assertNotIn("/app.js?v=recipes-1", SW)
        self.assertNotIn("/app.js?v=cals-90d-1", HTML)
        self.assertNotIn("/app.js?v=cals-90d-1", SW)
        self.assertNotIn("meal-gtasks-321-1", HTML)
        self.assertNotIn("meal-gtasks-321-1", SW)
        self.assertNotIn("paired-avgs-6", HTML)

...
class CacheAndHobbyLock(unittest.TestCase):
    def test_static_cache_bumped(self):
        ...
        self.assertIn("?v=bottle-charge-6", HTML)
        self.assertIn("?v=bottle-inline-1", HTML)
        self.assertIn("?v=paired-avgs-4", HTML)
        self.assertIn('const CACHE = "fitdash-shell-v64"', SW)
        self.assertIn("/styles.css?v=bottle-inline-1", SW)

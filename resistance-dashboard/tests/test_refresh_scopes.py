...
class CacheAndHobbyLock(unittest.TestCase):
    def test_static_cache_bumped(self):
        ...
        self.assertIn("?v=calorie-meta-bottom-1", HTML)
        self.assertIn("?v=paired-avgs-5", HTML)
        ...
        self.assertIn("/app.js?v=cals-75d-1", SW)
        self.assertIn("/app.js?v=cals-75d-1", HTML)
        self.assertNotIn("meal-gtasks-321-1", HTML)
        self.assertNotIn("meal-gtasks-321-1", SW)
        self.assertNotIn("paired-avgs-4", HTML)
